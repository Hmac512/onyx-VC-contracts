...
contract Verifier is AbstractBase, IVerifier {
    ...
    /// @param _rootIssuer The Keccack256 hashed form of the DID
    function setRootIssuer(bytes32 _rootIssuer)
        external
        onlyOwner
        confirmForwarder
    {
    ...
    function addKnownIssuer(bytes32 _issuer)
        external
        onlyOwner
        confirmForwarder
    {
    ...
    /// @param _issuer The Keccack256 hashed form of the DID
    function removeKnownIssuer(bytes32 _issuer)
        external
        onlyOwner
        confirmForwarder
    {
    ...
    function setRegistryAddress(IDIDRegistry _registry)
        external
        onlyOwner
        confirmForwarder
    {
